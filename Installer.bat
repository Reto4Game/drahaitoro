...
:install
    ...
    FINDSTR /V "127.0.0.1 s.optifine.net # INSERTED BY MINECRAFT CAPES" "%HOSTS_FILE%" > "%TEMP_HOSTS_FILE%"
    REM Add the redirect to the new file
    ECHO 127.0.0.1 s.optifine.net # INSERTED BY MINECRAFT CAPES >> "%TEMP_HOSTS_FILE%"
